...
def run_inference(args):
    ...
    for line in tqdm(questions):
        ...
        if args.keyframe_path!='None':
            # print(sample_set['duration_group'],type(sample_set['duration_group']))

            # if sample_set['duration_group']=='short' and args.keyframe_path_short is not None:
            #     args.keyframe_path = args.keyframe_path_short
        ...
        try:
            ...
            j+=1
            # print(f'load video error: {video_path}',j)
            continue
...
def parse_args():
    ...
    parser.add_argument("--keyframe_path_short", type=str, default=None)
