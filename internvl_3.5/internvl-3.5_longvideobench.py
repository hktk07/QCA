...
def run_inference(args):
    ...
    for line in tqdm(gt_qa_pairs):
        ...
        if args.keyframe_path!='None':
            ...
            # if sample_set['duration_group']==15 or sample_set['duration_group']==60:
            #     args.keyframe_path = 'qwen3-vl/longvideobench_keyframe/longvideobench_short_64frame_8clip'
